...
from .diagnostics import diagnostics, write_experiment_plan, write_window_calibration
...
def settings(arguments: argparse.Namespace) -> Config:
    ...
    return Config(scenarios=arguments.scenarios, residual_window=arguments.window,
                  ...
                  gap=arguments.gap, solver_threads=arguments.threads, nodes=nodes,
...
def main() -> None:
    ...
    processed = ROOT / "inputs/q4/processed"
    ...
    if arguments.command == "diagnostics":
        ...
        write_window_calibration(arguments.output)
        return
