...
PLAN = ROOT / "docs/2/final/第二问_最终建模思路_论文精简终版.md"
TASK = ROOT / "docs/2/final/Q2_Codex_最终模型修改任务书.md"
ACCELERATION_TASK = ROOT / "docs/2/final/Codex_问题二求解加速任务书.md"
# 以下为方案要求预注册但没有指定数值的数值计算设置，不是题设事实。
PROTOCOL = {
    "version": "q2-tail-reserve-final-20260912",
    ...
    "tail_stratification": True, "tail_fraction": 0.20,
    "dynamic_soc_reserve": True, "reserve_quantile": 0.80,
    "evaluation_initial_soc_kwh": 6000.0,
    "january_storage_operation": "inactive",
    "solver_gap": 0.01, "solver_seconds": 120.0,
    "refine_seconds": 5.0, "solver_threads": 1,
...
def signature():
    payload = (json.dumps(PROTOCOL, sort_keys=True).encode("utf-8")
               + PLAN.read_bytes() + TASK.read_bytes() + ACCELERATION_TASK.read_bytes())
