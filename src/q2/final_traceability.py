...
RULES = {
    ...
    "2.5.5": ("scenarios.py#cumulative_pressure;scenarios.py#construct;rolling.py#select_resolution", "test_dispatch.py#test_tail_strata_preserve_count_origins_and_probability_mass;test_dispatch.py#test_tail_stratification_does_not_increase_reduced_scenario_count", "scenarios"),
    "2.5.6": ("scenarios.py#construct;scenarios.py#weighted_quantile", "test_dispatch.py#test_tail_strata_preserve_count_origins_and_probability_mass;test_dispatch.py#test_weighted_quantile_uses_discrete_probability", "scenarios"),
    ...
    "2.7.4": ("scenarios.py#dynamic_reserve;policy.py#respond;policy.py#validate_replay;optimization.py#build_model", "test_dispatch.py#test_cumulative_pressure_and_dynamic_reserve_use_kwh_paths;test_dispatch.py#test_indicator_model_and_replay_share_dynamic_reserve;test_linear_policy.py#test_dynamic_reserve_linear_native_and_replay_are_equivalent", "main"),
    ...
    "2.7.7": ("optimization.py#build_model;optimization.py#solve_policy;linear_policy.py#build_linear_policy;rolling.py#make_day", "test_dispatch.py#test_indicator_model_and_replay_share_dynamic_reserve;test_linear_policy.py#test_dynamic_reserve_linear_native_and_replay_are_equivalent", "main"),
